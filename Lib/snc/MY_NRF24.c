...
//12. Begin function
void NRF24_Begin(SPI_HandleTypeDef pSPI, GPIO_TypeDef *pRF24GPIO, uint16_t pin_CS, uint16_t pin_CE)
{
	//Copy SPI handle variable
	memcpy(&nrf24_hspi, &pSPI, sizeof(pSPI));
	//Copy Pins and Port variables
	nrf24_PORT = pRF24GPIO;
	nrf24_CSN_PIN = pin_CS;
	nrf24_CE_PIN = pin_CE;
